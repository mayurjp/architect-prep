...
**Roles covered:** C# / .NET · ASP.NET MVC · ASP.NET Web API · SQL Server

This document contains:
1. **Part A** — Detailed, in-depth C# / .NET questions and answers (Q1–Q25, with the first 5 expanded to full depth).
2. **Part B** — Question banks (Basic / Intermediate / Advanced) for C#/.NET, ASP.NET MVC, ASP.NET Web API, and SQL Server.

---

# PART A — C# / .NET: Detailed Q&A
...
## Q6. What are `ref` and `out` parameters?
...
## Q13. What is garbage collection and generations?
...
## Q14. What is `IDisposable` and `using`?
...
## Q15. `Task` vs `Thread` vs `async/await`?
...
## Q16. What are extension methods?
...
## Q17. `Task.Run` vs `Task.Factory.StartNew`?
...
## Q18. `async/await` under the hood?
...
## Q19. What does `ConfigureAwait(false)` do?
...
## Q20. Covariance and contravariance?
...
## Q22. Explain the dispose pattern.
...
## Q23. What causes memory leaks in managed code?
...
## Q24. Value type vs reference type memory — stack vs heap?
...
## Q25. Main thread-synchronization primitives?
