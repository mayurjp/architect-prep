# Microservices & System Design with .NET

**A progressive Q&A study guide — Beginner → Mid → Advanced → Troubleshooting Scenarios**
...
**🟢 Beginner**
1. What is a Microservice vs. a Monolith?
...
**🟡 Mid**
6. Resilience: Retry, Timeout, Circuit Breaker (Polly)
7. Idempotency & the Saga pattern
8. Event-Driven Architecture & the Outbox pattern
9. CQRS & Event Sourcing

**🔴 Advanced**
10. Distributed Observability & OpenTelemetry
11. Kubernetes & Deployment Strategies
12. Security in Microservices

**🔴 Advanced — System Design**
13. Designing a complete e-commerce platform end-to-end

**🔴 Scenario / Troubleshooting**
14. A service is running slow — how do you troubleshoot?
15. A pod is unhealthy / crash-looping / OOMKilled
16. Adding a new requirement to a running system
17. Troubleshooting a message-driven system
...
## Q6. How do you build resilience? (Retry, Timeout, Circuit Breaker)
...
## Q7. Idempotency & the Saga Pattern
...
## Q8. Event-Driven Architecture & the Outbox Pattern
...
## Q10. Distributed Observability & OpenTelemetry
...
## Q11. Kubernetes & Deployment Strategies
...
## Q13. Design a complete e-commerce platform end-to-end
...
## Q14. A service is running slow — how do you troubleshoot?
...
## Q15. A pod is unhealthy / crash-looping / OOMKilled
...
## Q16. Adding a new requirement to a running system
...
## Q17. Troubleshooting a message-driven system
